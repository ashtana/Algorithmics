...
void find_distances(int knight_row, int knight_col, int num_rows, int num_cols, board min_moves) {
...
void solve(int pawn_row, int pawn_col, int num_rows, board min_moves) {
