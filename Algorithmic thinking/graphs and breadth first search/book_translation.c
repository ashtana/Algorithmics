...
// Рассмотрим задачу с платформы DMOJ(dmoj.ca) под номером ecna16d.

/*
Условие
Вы написали книгу на английском и хотите перевести ее на n других языков. Для этого вы нашли 
m переводчиков. Каждый переводчик знает два языка и может выполнить перевод за 
установленную плату. Например, один из них знает испанский и бенгали и берет за услугу $1800. 
Это означает, что ему можно поручить перевод книги с испанского на бенгали или 
с бенгали на испанский, заплатив $1800. Для получения версии книги на нужном языке может 
потребоваться серия из нескольких переводов. Например, если требуется перевести 
книгу с английского на бенгали, но переводчика в этой языковой паре нет, 
то можно вначале перевести ее с английского на испанский, а затем с испанского на бенгали.
Чтобы уменьшить число ошибок, вы должны минимизировать количество переводов, 
необходимое для получения версии на нужном языке. Если для достижения минимального числа 
переводов на целевой язык возможно несколько путей, то выбирать нужно самый дешевый. 
Цель заключается в минимизации числа переводов до целевого языка при наименьших затратах.
*/

/*
Входные данные
Входные данные представлены одним тестовым примером, состоящим из следующих строк:
 * Строки, содержащей два целых числа n и m, где n — количество целевых языков, 
 m — число переводчиков. Всего возможно не более 100 целевых языков и не более 4500 переводчиков.
 * Строки, содержащей n названий целевых языков. English в их число не входит.
 * m строк, каждая из которых содержит информацию об одном переводчике.
Каждая из этих строк содержит три параметра, разделенных пробелами: 
первый язык, второй язык и положительное целочисленное значение стоимости перевода между ними. 
Для каждой языковой пары предлагается не более одного переводчика.
*/

/*
Выходные данные
Требуется вывести минимальную стоимость перевода книги на все целевые языки, минимизировав 
при этом количество переводов для каждого языка. Если перевести книгу на все целевые языки 
невозможно, следует вывести impossible.
